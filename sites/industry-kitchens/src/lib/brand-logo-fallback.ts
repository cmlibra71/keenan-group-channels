...
//
// INDUSTRY KITCHENS ONLY. This file lives under `sites/industry-kitchens/` and
// is deliberately NOT mirrored into `template/` or Chefs Depot: Tim asked for it
// on an IK card, and Steve's opposite ruling (gRLRF8yu, 2026-08-10 — "the grey
// box stays, the fix is finding the products") still stands on Chefs Depot. Tim
// is the final word on customer-facing behaviour and his instruction is newer,
// so IK changes and CD does not. See docs/behaviour/catalogue.md.
//
