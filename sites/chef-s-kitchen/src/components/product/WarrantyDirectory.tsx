        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border">
              {filtered.map((entry) => (
                <tr key={entry.brand} className="text-text-body">
                  ...
                  <td className="px-3 py-2.5 whitespace-nowrap">
                    {entry.claimUrl ? (
                      ...
                      <span className="text-text-secondary">{entry.claimAction}</span>
                    )}
                  </td>
                  ...
                  <td className="px-3 py-2.5 text-text-secondary">{entry.equipment}</td>
                </tr>
              ))}
            </tbody>
          </table>
