      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
        <div>
          ...
          <div className="flex items-center gap-2 mt-2">
            <Calendar className="h-3.5 w-3.5 text-steel-400" strokeWidth={1.5} />
        ...
        <div className="sm:w-1/2">
          <p className="text-xs text-steel-400 mb-3 uppercase tracking-wider">Your accumulation progress</p>
          <div className="[&_p]:text-steel-400 [&_span]:text-steel-400 [&_.text-ink-900]:text-white [&_.text-steel-500]:text-steel-400 [&_.bg-steel-100]:bg-surface-dark-alt">
            <EntryAccumulationChart currentMonth={consecutiveMonths} />
          </div>
        </div>
      </div>

      <div className="mt-6 bg-sale/10 border border-sale/20 text-sale text-sm px-4 py-3">
