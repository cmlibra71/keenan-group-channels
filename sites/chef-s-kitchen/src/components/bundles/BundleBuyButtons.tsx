    ...
    <div>
      <div className="flex flex-col gap-3 sm:flex-row">
        <button
          ...
          className="flex-1 rounded-lg bg-ink-900 px-6 py-3 text-center font-semibold text-white hover:bg-ink-800 disabled:opacity-50"
        >
        ...
        <button
          ...
          onClick={() => run("quote")}
          disabled={isPending || disabled}
          className="flex-1 rounded-lg border border-ink-900 px-6 py-3 text-center font-semibold text-ink-900 hover:bg-steel-50 disabled:opacity-50"
        >
          Add bundle to quote
        </button>
      </div>
