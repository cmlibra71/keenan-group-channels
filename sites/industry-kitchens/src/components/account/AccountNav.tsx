...
/**
 * The account menu, Industry Kitchens dress.
 *
...
const ROW_IDLE = "text-zinc-600 hover:bg-zinc-100 hover:text-zinc-900";
const ROW_CURRENT = "bg-zinc-100 text-zinc-900 font-semibold";
    ...
    <nav aria-label="Account" className="lg:w-60 lg:shrink-0">
      ...
      <div className="lg:hidden">
        <button
          ...
          className="flex w-full items-center justify-between border border-zinc-200 bg-white px-4 py-3 text-sm font-semibold text-zinc-900"
        >
          <span className="flex items-center gap-2">
            <Menu className="h-4 w-4" />
            Account menu
          </span>
          {open && <X className="h-4 w-4 text-zinc-500" />}
        </button>
        {open && (
          <div
            id="account-nav-panel"
            className="border border-t-0 border-zinc-200 bg-white py-2"
          >
      ...
      <div className="hidden lg:block lg:sticky lg:top-24">
        <div className="border border-zinc-200 bg-white py-2">
