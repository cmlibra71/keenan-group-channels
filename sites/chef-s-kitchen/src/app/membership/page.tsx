...
export const metadata = {
  ...
  description:
    "Members don't get a discount. They get a different price tier. Member pricing from your first order, and it keeps stepping down as your spend builds.",
};
          ...
          <div className="grid gap-10 lg:grid-cols-[1.3fr_1fr] lg:items-start">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-relaxed text-text-secondary">
                The price on screen is our standard trade price — the one anyone can pay. Members buy
                as a group, and see a different number. Every line moves the day you&rsquo;re in, and
                keeps stepping down as your spend builds over twelve months.
              </p>
      ...
      <section className="section-bordered">
        <div className="container-page section-padding">
          <div className="mb-12 text-center">
            ...
            <h2 className="section-title">The price moves twice, and the first move is the big one.</h2>
            <p className="mx-auto mt-3 max-w-2xl text-text-secondary">
              Most schemes make you earn your way to anything worthwhile. This one gives you the step
              change on day one, then keeps going for as long as you keep buying. Partner Specials
              sit alongside both moves.
            </p>
          </div>

          <div className="grid gap-6 lg:grid-cols-3">
            <article className="rounded-2xl border border-border-strong bg-white p-6">
              <p className="eyebrow mb-2">Move one · joining</p>
            ...
            <article className="rounded-2xl border border-border-strong bg-white p-6">
              <p className="eyebrow mb-2">Alongside both moves</p>
              ...
              <p className="mt-3 text-xs text-text-muted">
                You always land on the lower of the two — and whatever you spend on a Partner Special
                still counts toward your rolling twelve months.
              </p>
            </article>
          </div>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            },
            {
              ...
              body: "Supplier bulk buys, clearance and end-of-line stock, offered to the group before it goes anywhere else. Some are already as sharp as they go — and every dollar still counts toward your spend.",
            },
            {
              title: "Member pricing on every line",
              body: "Applied automatically across the range, with no codes and no minimum order. Clearance, Partner Specials and special-order lines are priced separately — you always get the better of the two. Your level shows on your account and on every quote.",
            },
            {
            ...
            <div className="divide-y divide-border">
              {[
                ...
                },
                {
                  ...
                  a: "Where a clearance, end-of-line or Partner Special is sharper than your member price, you get the sharper one. Either way the full amount counts toward your spend and moves you up the levels.",
                },
                {
                  q: "Where member pricing applies",
                  a: "Member pricing runs across our range. Clearance, end-of-line, Partner Specials, indent and special-order lines, freight, installation and third-party service are priced on their own terms. Where one of those is sharper than your member price, you pay the sharper one — and everything you spend on goods still counts toward your level.",
                },
              ].map((item, i) => (
