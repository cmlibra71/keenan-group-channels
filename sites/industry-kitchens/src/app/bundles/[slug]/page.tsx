  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      <nav className="mb-6 text-sm text-zinc-500">
        ...
        <span className="text-zinc-700">{bundle.headline}</span>
      </nav>
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-zinc-100">
            {bundle.components.map((component) => (
              <tr key={component.sku} className="text-zinc-700">
                <td className="px-4 py-3">
                  ...
                  <span className="mt-0.5 block text-xs text-zinc-400">SKU: {component.sku}</span>
                  {component.missing && (
      ...
      <div className="mt-6 rounded-lg border border-zinc-200 p-6">
        <div className="flex justify-between text-sm">
          <span className="text-zinc-500">Components separately</span>
          <Price amount={bundle.componentTotal} className="font-medium" />
        </div>
        <div className="mt-2 flex justify-between text-sm">
          <span className="text-zinc-500">Bundle saving ({bundle.percent}%)</span>
