    ...
    <form onSubmit={onSubmit} className="border border-accent/30 rounded-lg p-4 space-y-4 bg-steel-50">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <div>
          ...
          <input ref={stateRef} name="state" type="text" defaultValue={initial?.state} className="mt-1 block w-full input" />
        </div>
        <div>
          <label className="field-label">Postcode</label>
          <input ref={postalCodeRef} name="postalCode" type="text" required defaultValue={initial?.postalCode} className="mt-1 block w-full input" />
        </div>
      </div>
