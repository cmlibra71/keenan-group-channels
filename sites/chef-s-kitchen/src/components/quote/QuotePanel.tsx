  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto px-6 py-4">
        ...
        <div className="mt-6">
          <label htmlFor="quote-name" className="field-label">
            Quote name <span className="text-sale-deep">*</span>
          </label>
          <input
            id="quote-name"
            type="text"
        ...
        <div className="mt-4">
          <label htmlFor="quote-comments" className="field-label">
            Quote comments
          </label>
          <textarea
            id="quote-comments"
        ...
        <div className="mt-4">
          <label htmlFor="quote-address" className="field-label">
            Delivery address <span className="text-sale-deep">*</span>
          </label>
          <select
            id="quote-address"
