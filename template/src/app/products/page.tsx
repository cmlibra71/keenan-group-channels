...
export default async function ProductsPage({
  ...
  // products in its allow-list. resolveAccessibleCategoryIds → null (unrestricted, use the
  // cached path), [] ('none', show nothing), or specific ids (restrict). Restricted queries
  // bypass the per-channel cache (results are per-group) and go straight to listForChannel.
