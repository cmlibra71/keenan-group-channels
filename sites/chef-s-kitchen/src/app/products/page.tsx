import { getProducts, getFeatureFlag, getMegaMenu, getHeaderNav, getMegaMenuHidden, productService, CHANNEL_ID } from "@/lib/store";
...
export default async function ProductsPage({
  ...
  const [{ products, total }, memberPricingEnabled, megaMenu, headerNav, hiddenDepartments] = await Promise.all([
    productsPromise,
