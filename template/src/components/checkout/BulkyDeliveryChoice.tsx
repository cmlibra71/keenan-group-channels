...
export function BulkyDeliveryChoice({
  ...
  return (
    <div className="border border-zinc-200 rounded-lg p-6">
      <h2 className="text-lg font-semibold text-zinc-900 mb-1">How should we deliver this?</h2>
          ...
          return (
            ...
            >
              <span className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold text-zinc-900">{copy.title}</span>
              </span>
              <span className="text-xs text-zinc-600">{copy.blurb}</span>
              <span className="text-xs font-medium text-zinc-900">{copy.note}</span>
            </label>
          );
        })}
      </div>
      ...
      {value === "specialised" && (
        <div className="mt-4 space-y-4 rounded-lg border border-amber-200 bg-amber-50 p-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <select
                ...
                required
                defaultValue=""
                className="mt-1 block w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm focus:border-zinc-500 focus:outline-none"
              >
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-zinc-700">
            <label className="flex items-center gap-2">
              <input type="checkbox" name="siteLoadingDock" value="1" className="accent-zinc-900" />
              Loading dock on site
            </label>
            <label className="flex items-center gap-2">
              <input type="checkbox" name="siteForklift" value="1" className="accent-zinc-900" />
              Forklift on site
            </label>
            <label className="flex items-center gap-2">
              <input type="checkbox" name="siteTwoPerson" value="1" className="accent-zinc-900" />
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              <label className="block text-sm font-medium text-zinc-700">until</label>
              <input
                type="time"
                name="siteWindowEnd"
                className="mt-1 block w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm focus:border-zinc-500 focus:outline-none"
