...
// Dynamic favicon. Uses the site's configured faviconUrl when set; otherwise
// derives an icon from the logo so every channel has a favicon. Falls back to a
// monogram if neither is available.
