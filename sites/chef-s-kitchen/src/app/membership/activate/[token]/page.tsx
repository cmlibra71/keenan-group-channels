...
export default async function ActivateMembershipPage({
  ...
  if (!context) {
    return (
      <div className="mx-auto max-w-lg px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-2xl font-bold text-ink-900 mb-3">This link has expired</h1>
        <p className="text-text-secondary">
          Activation links last 7 days. You can still join from the{" "}
          <Link href="/membership" className="font-medium text-ink-900 underline hover:no-underline">
            membership page
          </Link>
  ...
  if (context.alreadyMember) {
    return (
      <div className="mx-auto max-w-lg px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-2xl font-bold text-ink-900 mb-3">You&apos;re already a member</h1>
        <p className="text-text-secondary">
  ...
  return (
    <div className="mx-auto max-w-lg px-4 sm:px-6 lg:px-8 py-10">
      <h1 className="text-2xl font-bold text-ink-900 mb-2">Activate your account</h1>
