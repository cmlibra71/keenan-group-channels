...
function RangeFacet({
  ...
  return (
    <div className="pt-1">
      <div className="mb-2 flex items-center justify-between text-[12px] font-semibold text-teal-700">
      ...
      <div className="relative h-6">
        ...
        <div
          ...
          style={{ left: `${left}%`, width: `${width}%`, backgroundColor: "#0D9488" }}
        />
        {([0, 1] as const).map((which) => (
          <input
            ...
            onKeyUp={release}
            onBlur={release}
            className="pointer-events-none absolute inset-x-0 top-1/2 h-6 w-full -translate-y-1/2 appearance-none bg-transparent [&::-moz-range-thumb]:pointer-events-auto [&::-moz-range-thumb]:h-3.5 [&::-moz-range-thumb]:w-3.5 [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white [&::-moz-range-thumb]:bg-[#0D9488] [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:h-3.5 [&::-webkit-slider-thumb]:w-3.5 [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:bg-[#0D9488] [&::-webkit-slider-thumb]:shadow"
          />
        ))}
      </div>
