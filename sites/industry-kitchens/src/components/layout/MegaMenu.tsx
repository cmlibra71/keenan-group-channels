...
export function MegaMenu({
  ...
  return (
    <nav aria-label="Departments" className="relative hidden bg-zinc-900 xl:block">
...
function MegaPanel({ dept, feat }: { dept: MegaMenuNode; feat?: MegaMenuFeatured }) {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid max-w-[1100px] grid-cols-[1fr_1fr_1fr_240px] gap-6 rounded-b-lg border border-zinc-200 border-t-[3px] border-t-[#D94B2B] bg-white p-6 shadow-lg">
          {columns.map((col, i) => (
