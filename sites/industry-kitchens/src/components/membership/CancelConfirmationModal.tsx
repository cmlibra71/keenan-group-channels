    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white border border-zinc-200 rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={cancelling}
                className="flex-1 bg-zinc-900 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-zinc-800 transition-colors"
              >
                Keep Membership
              </button>
              <button
                ...
                disabled={cancelling}
                className="flex-1 border border-red-300 text-red-600 px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-50 disabled:opacity-50 transition-colors"
              >
